...
# 📖  First Capstone : HTML/CSS & JavaScript project <a name="about-project"></a>

**First Capstone: HTML/CSS & JavaScript** is website for IT meeting project build with HTML, CSS, Javascript , using design guidelines , a mobile first approach, with best practices, Github flow and a descriptive and easy to understand README file.
...
- [Live Demo Link](https://jojo987n.github.io/first-capstone/)
...
- [ ] implement additional pages, like the tickets page and the schedule page
